...
function check_answer_toggle() {
    if (g_check_answer_on) {
        ...
        $("#check_answer_button").html(d.replace("▲", "▼"));
...
function showHideSolutionHow (elementId){
...
function loadUrlWithoutHistory (URI){
    const baseURL = 'http://127.0.0.1:8000'
    window.location.replace(baseURL+URI);
